...
const CLIENT_SAFE_COLUMNS =
  "id, client_id, ticket_id, consecutivo_cliente, producto, asunto, descripcion, tipo, prioridad, estado, fecha_registro, fecha_entrega, dias_antiguedad, responsable, ai_summary, notas, case_agreements, case_actions, tiempo_cobrado_minutos, created_at, updated_at";
